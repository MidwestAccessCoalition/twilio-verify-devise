module ActionDispatch::Routing
  class Mapper
    ...
    def devise_authy(mapping, controllers)
      ...
      match "/#{mapping.path_names[:disable_twilio_verify]}", :controller => controllers[:devise_authy], :action => :POST_disable_twilio_verify, :as => :disable_twilio_verify, :via => :post
