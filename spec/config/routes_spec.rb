...
RSpec.describe "routes with devise_authy", type: :controller do
  describe "with default devise_for" do
    it "route to devise_authy#GET_verify_twilio_verify" do
      expect(get: '/users/verify_twilio_verify').to route_to("devise/devise_authy#GET_verify_twilio_verify")
    end

    it "routes to devise_authy#POST_verify_twilio_verify" do
    ...
    it "routes to devise_authy#POST_disable_twilio_verify" do
      expect(post: '/users/disable_twilio_verify').to route_to("devise/devise_authy#POST_disable_twilio_verify")
    end

    it "route to devise_authy#GET_verify_twilio_verify_installation" do
      expect(get: '/users/verify_twilio_verify_installation').to route_to("devise/devise_authy#GET_verify_twilio_verify_installation")
    end

    it "routes to devise_authy#POST_verify_twilio_verify_installation" do
      expect(post: '/users/verify_twilio_verify_installation').to route_to("devise/devise_authy#POST_verify_twilio_verify_installation")
    end
  ...
  describe "with customised mapping" do
    ...
    it "doesn't change routes not in custom mapping" do
      expect(post: '/lockable_users/disable_twilio_verify').to route_to("devise/devise_authy#POST_disable_twilio_verify")
